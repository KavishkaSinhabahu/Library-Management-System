...
public class UpdateBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Book Records");
        ...
        jXDatePicker1.setPreferredSize(new java.awt.Dimension(162, 25));
                ...
                .addGroup(jImagePanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jImagePanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jImagePanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jXDatePicker1, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (bookID.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse(rs.getString("publisher_date"));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (bname.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Enter Book Publisher Name", "Warning", JOptionPane.ERROR_MESSAGE);
        } else if (pdate == null) {
            ...
            try {
                ...
                ResultSet rs1 = MySQL.search("SELECT * FROM `books` WHERE `book_id`='" + bookID + "'");
                if (rs1.next()) {
                    MySQL.iud("UPDATE `books` SET `book_name`='" + bname + "',`publisher`='" + pname + "',`publisher_date`='" + ppdate + "',`category_id`='" + category_id + "' WHERE `book_id`='" + bookID + "'");
